...
// Redux
import { SetLearnMore , SetCard} from '../../redux/action/action';
import { LearnMoreMode , SetCardMode } from '../../redux/selector/selector';
import { useDispatch , useSelector } from "react-redux";
const Highlights = () => {
    const dispatch= useDispatch();
    const learnMore = useSelector(LearnMoreMode)
    const cardMode = useSelector(SetCardMode)
    const handleLearnMore = () =>{
        dispatch(SetLearnMore(!learnMore.mode))
    }
    const handleHightLight = () =>{
        dispatch(SetCard(!cardMode.mode))
    }
    return (
           ...
           <div className='hightlight_box'>
                <div className='hightlight_nav'>
                        ...
                        <div className='hightlight_nav_title2'>
                            ...
                            <Typography 
                                ...
                                variant="caption" display="block" gutterBottom>
                                    {!learnMore.mode ? 'Read More': 'Read Less'}
                            </Typography>
                        </div>
                        {learnMore.mode &&
                   ...
                   <div className='hightlight_nav_button'>
                        ...
                        <Switch defaultChecked onClick={handleHightLight} />
                    </div>
                </div>
                {cardMode.mode &&
